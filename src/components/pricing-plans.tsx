    ...
    <Suspense>
      <section className="container h-full w-full flex flex-col gap-4">
        <div className="relative max-w-xl mx-auto sm:text-center">
          <h3 className="text-accent-foreground text-3xl font-semibold sm:text-4xl">
            Simple pricing.
          </h3>
        ...
        {/* <div className="relative flex items-center justify-center">
          <label className="mr-3 min-w-[3.5rem] text-sm text-muted-foreground dark:text-gray-400">
            Monthly
          </label>
          <Switch
            id="billing-interval"
          ...
          />
          <label className="relative ml-3 min-w-[3.5rem] text-sm text-muted-foreground dark:text-gray-400">
            Annual
          </label>
        </div> */}
            ...
            >
              <div className="flex flex-col gap-4 p-4 justify-between row-span-2">
                ...
                <div className="flex flex-col justify-between">
                  <div
                    className={`text-4xl font-semibold text-accent-foreground`}
                  >
                ...
                >
                  ...
                  {item.name === "Pro" && <Icons.add className="h-4 w-4" />}
                  <span>{item.cta}</span>
                </Button>
              </div>
              <ul className="flex flex-col gap-2 p-4 row-span-3">
                <li className="pb-2 font-medium text-accent-foreground">
                  <p>Features</p>
                </li>
